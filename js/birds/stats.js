...
var Stats = function () {
	...
	function createPanel( id, fg, bg ) {
		...
		var div = createElement( 'div', id, 'padding:0 0 3px 3px;text-align:left;opacity:0;background:' + bg );
	...
	var ms = 0, msMin = Infinity, msMax = 0, msAvg=0;
	var count = 0;
	...
	return {
		...
		update: function () {
			...
			startTime = this.end();
			count++;
			msAvg=msAvg*(count-1)/count+ms/count;
			// console.log(msAvg);
